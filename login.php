	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/lombok5.jpg);">
					<div class="desc">
						<div class="container">
							<div class="row">
										...
										<div class="tab-content">
											<form name="formLogin" method="post" action="login.php">
												<div role="tabpanel" class="tab-pane" id="flights">
													<div class="row">
														<h1 align="center">Login Ke Sangihe Dive Center</h1>
								...
								<div class="desc2 animate-box">
									<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
										...
										<h2 align="center">Hanya di Sangihe Dive Center</h2>
										<h3 align="center">Untuk liburan bawah laut Yang Aman, Nyaman dan Ramah dikantong</h3>
				...
				<div class="container">
					...
					<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
						<div class="row animate-box">
							<div class="col-md-6">
								<h3 class="section-title">Sangihe Dive Center</h3>
								<p>Memudahkan para traveler dalam melakukan perjalanan wisata bawah laut di Kepulauan Sangihe.</p>
								<ul class="contact-info">
									<li><i class="icon-location-pin"></i>JL Cendrawasih</li>
									<li><i class="icon-phone2"></i>0871313131333</li>
									<li><i class="icon-mail"></i><a href="#">sangihedc@gmail.com</a></li>
									<li><i class="icon-globe2"></i><a href="#">sangihedivecenter.com</a></li>
								</ul>
							</div>
							<div class="col-md-6">
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<p>
												<input type="radio" name="jekel" value="L" required>Laki-laki <br />

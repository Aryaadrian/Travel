	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/bgprofil.jpg);">
					<div class="desc">
						<div class="container">
							<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h2 align="left">Selamat Datang </h2>
									<h2 align="left">Sangihe Dive Center</h2>
									<h3 align="left">Liburan Bersama Keluarga Akan Lebih Asyik</h3>

	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/bghotel.jpg);">
					<div class="desc">
						<div class="container">
							<div class="row">
								...
								<div class="desc2 animate-box">
									<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
										...
										<h3 align="center">Asiknya Menginap Di Hotel Terbaik Di Kepulauan Sangihe</h3>
										<h2 align="center">Bersama Sangihe Dive Center</h2>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							<h3>Daftar Hotel Pilihan</h3>
							<p>Di Sangihe Dive Center</p>
						</div>
					</div>

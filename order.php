	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				<div class="fh5co"></div>
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/lombok2.jpg);">
					<div class="desc">
						<div class="container">
							<div class="row">
								...
								<div class="desc2 animate-box">
									<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
										...
										<h2 align="center">Liuran Di Lombok Utara</h2>
										<h3 align="center">Bersama Enjoy Tour And Travel</h3>
										<h2 align="center">Harga Bersahabat</h2>

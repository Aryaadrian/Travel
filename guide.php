	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/bgpakett.jpg">
					<div class="desc">
						<div class="container">
							<div class="row">
								...
								<div class="fh5co-blog animate-box">
									...
									<div class="blog-text">
										<div class="prod-title">
											...
											<p><a href="tampilGuide.php?id=<?php echo $x['id'] ?>">Learn More...</a></p>
										</div>
									</div>
								</div>
							</div>

...
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="ajax/edit_member.php">List Guide</a></li>
							...
							?>
									...
									<tr>
										...
										<td>
											...
											<a href="#" onclick="confirm_modal('prosesGuide.php?id=<?php echo $x['id']; ?>&aksi=hapus');"><button type="button" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Data"><i class="fa fa-trash-o"></i></button></a>
										</td>
									</tr>
...
include('../modal/modal_tambah_guide.php');

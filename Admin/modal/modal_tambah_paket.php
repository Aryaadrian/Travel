          ...
          <form action="prosesPaket.php?aksi=tambah" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Nama" name="nama_paket" required>
              </div>
            </div>
            <div class="col-md-6">
              <label>Harga</label>
              <div class="form-group">
                <input type="number" class="form-control" placeholder="Harga" name="harga_paket" required>
              </div>
            </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <textarea name="ket_paket" class="form-control" cols="30" rows="7" placeholder="Alamat" required></textarea>

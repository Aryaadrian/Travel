				...
				<ul class="nav main-menu">
					...
					<li class="dropdown">
						<a href="ajax/wisata.php" class="ajax-link">
							<i class="fa fa-bar-chart-o"></i>
							<span class="hidden-xs">List Wisata</span>
						</a>

					</li>
					<li class="dropdown">
						<a href="ajax/guide.php" class="ajax-link">
							<i class="fa fa-bar-chart-o"></i>
							<span class="hidden-xs">List guide</span>
						</a>
					...
					<li class="dropdown">
						<a href="ajax/penginapan.php" class="ajax-link">
							...
							<span class="hidden-xs">Penginapan</span>
						</a>
					...
					<li class="dropdown">
						<a href="ajax/paket_wisata.php" class="ajax-link">
							<i class="fa fa-pencil-square-o"></i>
							<span class="hidden-xs">Paket Wisata</span>
						</a>
